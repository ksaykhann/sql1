...
INSERT INTO person_discounts(id, person_id, pizzeria_id, discount)
    ...
    (
       ...
       WHEN COUNT(person_order.person_id) = 2 THEN 22
        ...
        END)
    FROM person_order
    JOIN person_pizzeria_id ON person_pizzeria_id.menu_id = person_order.menu_id
    GROUP BY person_order.person_id, person_pizzeria_id.pizzeria_id
    ORDER BY person_id
)
;
